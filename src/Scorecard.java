...
public class Scorecard {
     ...
     */
    public void printPossibleScores(){
    ...
    public void chooseScore(){
        ...
        do{
            System.out.println("Enter a code to place your score: ");
    ...
    public void printScorecard(){
        ...
        for(int i=0;i<scorecardList.size();i++){
            if(scorecardList.get(i)[2].equals("u")){
                ...
                System.out.println(scorecardList.get(i)[0]+"\t\t\t"+lineTotal);
            }else if(scorecardList.get(i)[0].equals("3K")){
                if(upperTotal>=63){
                    bonus = 35;
                }
                System.out.println("-----------------");
                System.out.println("Sub Total\t\t"+Integer.toString(upperTotal));
                System.out.println("Bonus\t\t\t"+Integer.toString(bonus));
                System.out.println("-----------------");
                System.out.println("Upper Total\t\t"+Integer.toString(upperTotal+bonus)+"\n");
                lineTotal = scorecardList.get(i)[3];
        ...
        System.out.println("-----------------");
        System.out.println("Lower Total\t\t"+Integer.toString(lowerTotal));
        System.out.println("-----------------");
        System.out.println("Grand Total\t\t"+Integer.toString(grandTotal)+"\n");
    }
     ...
     */
    public ArrayList getUnusedScoresList(){
